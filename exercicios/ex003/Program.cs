//Crie um programa que receba o mês em número e informe o nome dele e quantos dias ele tem, utilizando o Switch Case
...
switch (mes)
{
    ...
    case "7":
        Console.WriteLine("Julho com 31 dias!");
         break;
    case "8":
        Console.WriteLine("Agosto com 30 dias!");
         break;
    case "9":
        Console.WriteLine("Setembro com 31 dias!");
         break;
    case "10":
